...
| PHPStan | Niveau 2 sur le composant, avec baseline | `phpstan.neon.dist`, 119 entrées dans la baseline |
...
- Classer les 119 entrées actuelles par fichier et par catégorie.
...
119 entrées (contre 251 au dernier relevé historique de ce document), après
