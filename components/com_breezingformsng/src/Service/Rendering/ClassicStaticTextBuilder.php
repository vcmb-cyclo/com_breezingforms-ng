...
final class ClassicStaticTextBuilder
{
    public function buildIcon(
        ...
        $wrapperAttributes = $showBorder
            ? ' onmouseout="ff_hideIconBorder(this);" onmouseover="ff_dispIconBorder(this);" '
                . 'style="padding:3px;' . $style . '"'
            : '  style="' . $style . '"';
        $swap = $hoverSource !== ''
            ? 'onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage(\'ff_img' . $elementId
                . '\',\'\',\'' . $hoverSource . '\',1);" '
            : '';
        ...
        $content = match ($layout) {
            1 => $indent . $indent . '<table id="ff_elem' . $elementId . '" cellpadding="1" cellspacing="0" border="0" '
                . $swap . '>' . $newline
            ...
            2 => $indent . $indent . '<table id="ff_elem' . $elementId . '" cellpadding="2" cellspacing="0" border="0" '
                . $swap . '>' . $newline
                . $indent . $indent . $indent . '<tr><td style="text-align:center;">' . $label . '</td></tr>' . $newline
                . $indent . $indent . $indent . '<tr><td style="text-align:center;">' . $image . '</td></tr>' . $newline
                . $indent . $indent . '</table>' . $newline,
            3 => $indent . $indent . '<span id="ff_elem' . $elementId . '" ' . $swap
                . ' style="vertical-align:middle;">' . $newline
                . $indent . $indent . $indent . $label . ' &nbsp;' . $image . $newline
                . $indent . $indent . '</span>' . $newline,
            4 => $indent . $indent . '<span id="ff_elem' . $elementId . '" ' . $swap
                . ' style="vertical-align:middle;">' . $newline
            ...
            0 => $indent . $indent . '<span id="ff_elem' . $elementId . '" ' . $swap . '>' . $newline
                ...
                . $indent . $indent . '</span>' . $newline,
            default => $indent . $indent . '<span id="ff_elem' . $elementId . '" ' . $swap
                . ' style="vertical-align:middle;">' . $newline
                . $indent . $indent . $indent . $image . '&nbsp; ' . $label . $newline
                . $indent . $indent . '</span>' . $newline,
        };

        return $indent . '<div id="ff_div' . $elementId . '"' . $wrapperAttributes
            . $classAttribute . '>' . $newline
    ...
    public function buildTooltip(
        ...
        $tooltipTitle = '<strong>' . htmlspecialchars(strip_tags(trim($title)), ENT_QUOTES, 'UTF-8')
        ...
        return $indent . '<div id="ff_div' . $elementId . '" style="' . $style . '" title="' . $tooltipTitle . '"'
            ...
            . $indent . $indent . '<img src="' . $source . '" alt="" border="0"' . $imageClassAttribute
            . '/>' . $newline
            . $indent . '</div>' . $newline;
    }
