...
| PHPStan | Niveau 2 sur le composant, avec baseline | `phpstan.neon.dist`, 131 entrées dans la baseline |
...
- Classer les 131 entrées actuelles par fichier et par catégorie.
...
131 entrées (contre 251 au dernier relevé historique de ce document), après
