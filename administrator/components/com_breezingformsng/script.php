...
class com_breezingformsngInstallerScript
{
    ...
    function postflight($type, $parent)
    {
        ...
        $base_path = JPATH_SITE . '/administrator/components/com_breezingformsng/plugins';
    ...
    {
        $quickTasks = array(
            'index.php?option=com_breezingformsng&act=manageforms' => array(
                'menu-quicktask' => 'index.php?option=com_breezingformsng&act=manageforms&task=quickmode',
                'menu-quicktask-title' => 'COM_BREEZINGFORMS_MENUS_NEW_FORM',
                'menu-quicktask-icon' => 'plus',
            ),
            'index.php?option=com_breezingformsng&act=managescripts' => array(
                'menu-quicktask' => 'index.php?option=com_breezingformsng&act=managescripts&task=new',
                'menu-quicktask-title' => 'COM_BREEZINGFORMS_MENUS_NEW_SCRIPT',
                'menu-quicktask-icon' => 'plus',
            ),
            'index.php?option=com_breezingformsng&act=managepieces' => array(
                'menu-quicktask' => 'index.php?option=com_breezingformsng&act=managepieces&task=new',
                'menu-quicktask-title' => 'COM_BREEZINGFORMS_MENUS_NEW_PIECE',
                'menu-quicktask-icon' => 'plus',
            ),
            'index.php?option=com_breezingformsng&act=integrate' => array(
                'menu-quicktask' => 'index.php?option=com_breezingformsng&act=integrate&task=add',
