			...
			if ($row->type == 'Query List') {
				...
				function qcolDisplay() {
					...
					for (r = 0; r < qcolRowCnt; r++) {
						...
						// ordering
						if (r > 0)
							row.cells[qcolCellOrderup].innerHTML = '<a href="javascript:qcolOrderup(' + r + ')"><img src="media/com_breezingformsng/images/site/icons/uparrow.png" alt="^" border="0"/><\/a>';
						else
							row.cells[qcolCellOrderup].innerHTML = '';
						if (r < qcolRowCnt - 1)
							row.cells[qcolCellOrderdown].innerHTML = '<a href="javascript:qcolOrderdown(' + r + ')"><img src="media/com_breezingformsng/images/site/icons/downarrow.png" alt="v" border="0"/><\/a>';
						else
										...
										<td nowrap>
											<input type="radio" id="flag10" name="flag1" value="0" <?php if ($row->flag1 == 0)
												echo ' checked="checked"'; ?> onclick="disptooltipurl(this.value)" /><label for="flag10"> <img
													src="<?php echo $ff_mossite; ?>media/com_breezingformsng/images/site/js/ThemeOffice/tooltip.png"
													alt="" border="0" /></label>&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" id="flag11" name="flag1" value="1" <?php if ($row->flag1 == 1)
												echo ' checked="checked"'; ?> onclick="disptooltipurl(this.value)" /><label for="flag11"> <img
													src="<?php echo $ff_mossite; ?>media/com_breezingformsng/images/site/js/ThemeOffice/warning.png"
													alt="" border="0" /></label>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				for ($i = 0; $i < count($rows); $i++) {
					...
					<tr class="row<?php echo $k ?>">
						...
						<td nowrap align="center">
							<?php
							if ($row->published == "1") {
								echo "<a href=\"#unpublish\" onClick=\"return listItemTask('cb" . $i . "','unpublish')\"><img src=\"media/com_breezingformsng/images/site/icons/publish_g.png\" alt=\"+\" border=\"0\" /></a>";
							} else {
								echo "<a href=\"#publish\" onClick=\"return listItemTask('cb" . $i . "','publish')\"><img src=\"media/com_breezingformsng/images/site/icons/publish_x.png\" alt=\"-\" border=\"0\" /></a>";
							} // if
							?>
						</td>
						<td nowrap align="right">
							<?php
							if ($i > 0)
								echo "<a href=\"#orderup\" onClick=\"return listItemTask('cb" . $i . "','orderup')\"><img src=\"media/com_breezingformsng/images/site/icons/uparrow.png\" alt=\"^\" border=\"0\" /></a>";
							?>
						</td>
						<td nowrap align="left">
							<?php
							if ($i < count($rows) - 1)
								echo "<a href=\"#orderdown\" onClick=\"return listItemTask('cb" . $i . "','orderdown')\"><img src=\"media/com_breezingformsng/images/site/icons/downarrow.png\" alt=\"v\" border=\"0\" /></a>";
							?>
						</td>
						<td nowrap align="right">
							<?php echo $row->posx;
