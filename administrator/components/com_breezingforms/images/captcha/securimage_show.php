...
include JPATH_SITE . '/media/com_breezingforms/images/site/captcha/securimage.php';
...
$img->show(JPATH_SITE . '/media/com_breezingforms/images/site/captcha/backgrounds/bg6.jpg');
