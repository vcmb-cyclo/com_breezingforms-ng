...
" . QuickModeUploadQueueItemMarkupBuilder::build((int) $mdata['dbId'], (string) $this->cancelImagePath, true, false) . "
" . QuickModeUploadCancelScriptBuilder::build((string) $multiSelection, (int) $mdata['dbId'], true, chr(10)) . "
