					...
					<td nowrap>
						...
						for ($k = 0; $k < $cnt; $k++) {
							...
							echo
								...
								'&nbsp;<label for="img' . $k . '">' .
								'<img src="' . $ff_mossite . '/media/com_breezingforms/images/site/' . $img . '" alt="" border="0"/>' .
								'</label>';
							$x++;
						} // for
						$opt = '';
						...
						<td nowrap valign="top" align="center">
							...
							if ($row->published == "1") {
								?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','unpublish')"><img
										src="media/com_breezingforms/images/site/icons/publish_g.png" alt="+" border="0" /></a>
								<?php
							} else {
								?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','publish')"><img
										src="media/com_breezingforms/images/site/icons/publish_x.png" alt="-" border="0" /></a>
								<?php
							} // if
							?>
						</td>
						<td nowrap valign="top" align="right">
							...
							if ($i > 0) {
								?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','orderup')"><img
										src="media/com_breezingforms/images/site/icons/uparrow.png" alt="^" border="0" /></a>
								<?php
							} // if
							?>
						</td>
						<td nowrap valign="top" align="left">
							...
							if ($i < count($rows) - 1) {
								?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','orderdown')"><img
										src="media/com_breezingforms/images/site/icons/downarrow.png" alt="v" border="0" /></a>
								<?php
							} // if
							?>
						</td>
