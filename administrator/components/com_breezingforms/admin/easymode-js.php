		...
		this.createElementByType = function (typeName, rndId) {
			...
			switch (typeName) {
				...
				case 'bfCaptcha':
					...
					imageHolder.setAttribute('src', 'media/com_breezingforms/images/site/captcha/securimage_show.php');
				...
				case 'bfIcon':
					...
					var iconImage = '<?php echo Uri::root() ?>media/com_breezingforms/images/site/next.png';
					...
					data3 = '<?php echo Uri::root() ?>media/com_breezingforms/images/site/next_f2.png',
						data1 = iconImage;
				...
				case 'bfTooltip':
					...
					element.setAttribute('name', 'ff_nm_' + rndId + '[]');
					element.setAttribute('class', 'ff_elem');
					element.setAttribute('src', '<?php echo Uri::root() ?>/media/com_breezingforms/images/site/tooltip.png');
					JQuery(element).click(appScope.resizableElement);

					options = { text: 'Some <em>hint</em> or <strong/>warning</strong> for the user', image: '<?php echo Uri::root() ?>/media/com_breezingforms/images/site/tooltip.png', type: 'info' };
				...
				case 'bfSofortueberweisung':
					...
					var iconImage = '<?php echo Uri::root() ?>media/com_breezingforms/images/site/200x65px.png';
