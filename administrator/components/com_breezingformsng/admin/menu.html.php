					...
					<td nowrap>
						...
						for ($k = 0; $k < $cnt; $k++) {
							...
							echo
								...
								'&nbsp;<label for="img' . $k . '">' .
								'<img src="' . $ff_mossite . '/media/com_breezingformsng/images/site/' . $img . '" alt="" border="0"/>' .
								'</label>';
							$x++;
						} // for
						$opt = '';
						...
						<td nowrap valign="top" align="center">
							...
							if ($row->published == "1") {
								?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','unpublish')"><img
										src="media/com_breezingformsng/images/site/icons/publish_g.png" alt="+" border="0" /></a>
								<?php
							} else {
								?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','publish')"><img
										src="media/com_breezingformsng/images/site/icons/publish_x.png" alt="-" border="0" /></a>
								<?php
							} // if
							?>
						</td>
