...
');
        ...
        Factory::getApplication()->getDocument()->addScript(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/scrollto.js');
...
var toggleFieldsArray = ' . $this->toggleFields . ';
        ...
        if ($this->rootMdata['lastPageThankYou']) {
            ...
            // loading remodal
            Factory::getApplication()->getDocument()->addStyleSheet(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/remodal/remodal.css');
            Factory::getApplication()->getDocument()->addStyleSheet(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/remodal/remodal-default-theme.css');
            Factory::getApplication()->getDocument()->addScript(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/remodal/remodal.min.js');
            Factory::getApplication()->getDocument()->getWebAssetManager()->addInlineScript("\n" . '
        ...
        Factory::getApplication()->getDocument()->addStyleSheet(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/ladda/ladda-themeless.min.css');
        Factory::getApplication()->getDocument()->addScript(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/ladda/spin.min.js');
        Factory::getApplication()->getDocument()->addScript(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/ladda/ladda.min.js');
        Factory::getApplication()->getDocument()->addScript(Uri::root(true) . '/components/com_breezingformsng/libraries/jquery/ladda/ladda.jq.min.js');
    ...
    public function process(&$dataObject, $parent = null, $parentPage = null, $index = 0, $childrenLength = 0, $parentFull = null)
    {
        if (isset($dataObject['attributes']) && isset($dataObject['properties'])) {
            ...
            if ($mdata['type'] == 'page') {
                ...
                if (Factory::getApplication()->getInput()->getInt('ff_page', 1) >= $parentPage['pageNumber'] && !($this->rootMdata['lastPageThankYou'] && $parentPage['pageNumber'] == count($this->dataObject['children']))) {
                    $display = ' style="pointer-events:auto;opacity:1.0"';
                } else if (Factory::getApplication()->getInput()->getInt('ff_page', 1) < $parentPage['pageNumber'] && !($this->rootMdata['lastPageThankYou'] && $parentPage['pageNumber'] == count($this->dataObject['children']))) {
                    $display = ' style="pointer-events:none;opacity:0.4"';
