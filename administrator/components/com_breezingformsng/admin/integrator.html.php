...
class BFIntegratorHtml{
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm">
                ...
                <table cellpadding="4" cellspacing="0" border="0" width="100%"  class="adminlist table table-striped">
                    ...
                    <tr class="<?php echo "row$k"; ?>">
                        ...
                        <td><a href="index.php?option=com_breezingformsng&act=integrate&task=edit&id=<?php echo $rule->id; ?>"><?php echo htmlentities($rule->name, ENT_COMPAT, 'UTF-8') ?></a></td>
                        <td><a href="index.php?option=com_breezingformsng&act=integrate&task=edit&id=<?php echo $rule->id; ?>"><?php echo htmlentities($rule->type, ENT_COMPAT, 'UTF-8') ?></a></td>
    ...
    public static function edit($rule, $items, $tables, $forms, $formElements, $criteriaForm, $criteriaJoomla, $criteriaFixed, $showType = 'all'){
        ...
        if($rule != null){
            ...
            <form action="index.php?option=com_breezingformsng&act=integrate" method="post" name="addItemForm">
                <input type="hidden" name="publish_id" value="-1" />
            ...
            <form action="index.php?option=com_breezingformsng&act=integrate" method="post" name="saveCodeForm">
