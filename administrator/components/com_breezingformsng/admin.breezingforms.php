...
// purge ajax save
$sourcePath = JPATH_SITE . '/components/com_breezingformsng/exports/';
...
$sourcePath = JPATH_SITE . '/administrator/components/com_breezingformsng/packages/';
if (@file_exists($sourcePath) && @is_readable($sourcePath) && @is_dir($sourcePath) && $handle = @opendir($sourcePath)) {
    while (false !== ($file = @readdir($handle))) {
...
if (!file_exists(JPATH_SITE . '/media/breezingforms/index.html')) {
    File::copy(
        JPATH_SITE . '/components/com_breezingformsng/index.html',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/mailtpl')) {
    Folder::copy(
        JPATH_ADMINISTRATOR . '/components/com_breezingformsng/mailtpl/',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/pdftpl')) {
    Folder::copy(
        JPATH_ADMINISTRATOR . '/components/com_breezingformsng/pdftpl/',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/downloadtpl')) {
    Folder::copy(
        JPATH_SITE . '/components/com_breezingformsng/downloadtpl/',
...
if (!file_exists(JPATH_SITE . '/media/breezingforms/downloadtpl/stripe_download.php')) {
    File::copy(
        JPATH_SITE . '/components/com_breezingformsng/downloadtpl/stripe_download.php',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/uploads')) {
    ...
    File::copy(
        JPATH_SITE . '/components/com_breezingformsng/uploads/index.html',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/dropbox')) {
    ...
    File::copy(
        JPATH_SITE . '/administrator/components/com_breezingformsng/libraries/dropbox/config.json',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/themes')) {
    Folder::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode/',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/themes-bootstrap4')) {
    Folder::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode-bootstrap4/',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/themes-bootstrap5')) {
    Folder::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode-bootstrap5/',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/themes/images')) {
    Folder::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode/images/',
...
if (!is_dir(JPATH_SITE . '/media/breezingforms/themes/images/icons-png/')) {
    Folder::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode/images/icons-png/',
...
if (!file_exists(JPATH_SITE . '/media/breezingforms/themes/jq.mobile.1.4.5.min.css')) {
    File::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode/jq.mobile.1.4.5.min.css',
...
if (!file_exists(JPATH_SITE . '/media/breezingforms/themes/jq.mobile.1.4.5.icons.min.css')) {
    File::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode/jq.mobile.1.4.5.icons.min.css',
...
if (!file_exists(JPATH_SITE . '/media/breezingforms/themes/ajax-loader.gif')) {
    File::copy(
        JPATH_SITE . '/components/com_breezingformsng/themes/quickmode/ajax-loader.gif',
...
if (!isset($ff_compath)) { // joomla!
    ...
    $ff_admpath = JPATH_ADMINISTRATOR . '/components/com_breezingformsng';
...
function addComponentMenu($row, $parent, $copy = false)
{
    ...
    try {
        $db->setQuery("Select component_id From #__menu Where link = 'index.php?option=com_breezingformsng' And parent_id = 1");
    ...
    if ($result) {
        ...
        return _ff_query(
            ...
            "1, " . intval($result) . ", 1, 'media/com_breezingformsng/images/site/$row->img',( Select mlftrgt From (Select max(mlft.rgt)+1 As mlftrgt From #__menu As mlft) As tbone ),( Select mrgtrgt From (Select max(mrgt.rgt)+2 As mrgtrgt From #__menu As mrgt) As filet )" .
            ")",
            true
        );
    } else {
...
function updateComponentMenus($copy = false)
{
    ...
    if (trim($protids) != '') {
        _ff_query(
            "delete from #__menu " .
            "where `link` Like 'index.php?option=com_breezingformsng&act=run%' " .
