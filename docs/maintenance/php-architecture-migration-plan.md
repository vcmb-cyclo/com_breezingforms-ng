...
| PHPStan | Niveau 2 sur le composant, avec baseline | `phpstan.neon.dist`, 123 entrées dans la baseline |
...
- Classer les 123 entrées actuelles par fichier et par catégorie.
...
123 entrées (contre 251 au dernier relevé historique de ce document), après
