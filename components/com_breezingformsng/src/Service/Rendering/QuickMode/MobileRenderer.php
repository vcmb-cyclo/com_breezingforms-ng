                ...
                switch ($mdata['bfType']) {
                    ...
                    case 'bfFile':
                        if ((isset($mdata['flashUploader']) && $mdata['flashUploader']) || (isset($mdata['html5']) && $mdata['html5'])) {
							...
							<img style=\"cursor: pointer;\" id=\"bfPickFiles" . $mdata['dbId'] . "\" src=\"" . $this->uploadImagePath . "\" border=\"0\" width=\"" . $uploadOptions['buttonWidth'] . "\" height=\"" . $uploadOptions['buttonHeight'] . "\"/>
...
" . QuickModeUploadQueueItemMarkupBuilder::build((int) $mdata['dbId'], (string) $this->cancelImagePath, false, true) . "
