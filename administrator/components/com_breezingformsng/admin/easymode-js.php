		...
		this.createElementByType = function (typeName, rndId) {
			...
			switch (typeName) {
				...
				case 'bfCaptcha':
					...
					imageHolder.setAttribute('src', 'media/com_breezingformsng/images/site/captcha/securimage_show.php');
				...
				case 'bfIcon':
					...
					var iconImage = '<?php echo Uri::root() ?>media/com_breezingformsng/images/site/next.png';
					...
					data3 = '<?php echo Uri::root() ?>media/com_breezingformsng/images/site/next_f2.png',
						data1 = iconImage;
				...
				case 'bfTooltip':
					...
					element.setAttribute('name', 'ff_nm_' + rndId + '[]');
					element.setAttribute('class', 'ff_elem');
					element.setAttribute('src', '<?php echo Uri::root() ?>/media/com_breezingformsng/images/site/tooltip.png');
					JQuery(element).click(appScope.resizableElement);

					options = { text: 'Some <em>hint</em> or <strong/>warning</strong> for the user', image: '<?php echo Uri::root() ?>/media/com_breezingformsng/images/site/tooltip.png', type: 'info' };
				...
				case 'bfSofortueberweisung':
					...
					var iconImage = '<?php echo Uri::root() ?>media/com_breezingformsng/images/site/200x65px.png';
	...
	var bf_submitbutton = function (pressbutton) {
		...
		switch (pressbutton) {
			...
			case 'save':
				...
				break;
			case 'editform':
				location.href = "index.php?option=com_breezingformsng&task=editform&act=editpage&form=<?php echo $formId ?>";
				break;
			case 'preview':
				...
				SqueezeBox.loadModal("<?php echo Uri::root() ?>index.php?format=html&tmpl=component&option=com_breezingformsng&ff_form=<?php echo $formId ?>&ff_page=<?php echo $page ?>", "iframe", 820, 400);
				break;
			case 'preview_site':
				SqueezeBox.initialize({});
				...
				SqueezeBox.loadModal("<?php echo Uri::root() ?>index.php?option=com_breezingformsng&ff_form=<?php echo $formId ?>&ff_page=<?php echo $page ?>", "iframe", 1024, 400);
				break;
			default:
				break;
		}
