...
class EasyModeHtml
{
	...
	public static function showApplication($formId = 0, $formName = '', $templateCode = '', $callbackParams = array(), $elementScripts = array(), $pages = 1, $page = 1)
	{
		...
		<style type="text/css">
			...
			#trashcan-box {
				height: 100px;
				background: #fbfbfb url(<?php echo Uri::root() . 'administrator/components/com_breezingformsng/libraries/jquery/themes/easymode/i/trash-here.png'; ?>) center no-repeat;
				margin-bottom: 10px;
			}
			...
			.ff_dragBox {
				...
				cursor: move;
				float: left;
				background-image: url("<?php echo Uri::root() . 'administrator/components/com_breezingformsng/libraries/jquery/hand_icon.png' ?>");
			}
		...
		<style>
			...
			.droppableArea {
				...
				overflow: auto;
				background: #f6f6f6 url(<?php echo Uri::root() . 'administrator/components/com_breezingformsng/libraries/jquery/themes/easymode/i/drag-here.png'; ?>) center no-repeat;
