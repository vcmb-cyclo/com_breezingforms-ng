...
class bfRecordManagement
{
    ...
    function getCsvImport()
    {
        ...
        <form action="index.php?option=com_breezingformsng&act=managerecords&task=setcsvimport&tmpl=component" method="post"
    ...
    function closeSquBox()
    {
        ...
        <script type="text/javascript">
            window.top.location.href = "index.php?option=com_breezingformsng&act=managerecords&task=";
        </script>
        <?php
    }
        ...
        Factory::getApplication()->getDocument()->getWebAssetManager()->addInlineScript('  
                ...
                jQuery("joomla-toolbar-button").click( function(e){
                    ...
                    switch (pressbutton) {
                        case "csvimport":
                            ...
                            let new_url = "index.php?option=com_breezingformsng&act=managerecords&task=csvimport&form_selection="+form_selection+"&tmpl=component";
                        ...
                        case "archived":
                            ...
                            jQuery("#bfSelectionForm").attr("action", "index.php?option=com_breezingformsng&act=managerecs&task="+pressbutton+"&form_selection="+form_selection);
            ...
            function bf_set_flag(column,flag,record_id,flag_div_id){
                jQuery.ajax({
                    ...
                    success: function(){
                        var viewed = "<a href=\"javascript:bf_set_flag(\'"+column+"\',true,\'"+record_id+"\',\'"+flag_div_id+"\')\"><img src=\"media/com_breezingformsng/images/site/icons/publish_x.png\" border=\"0\"></a>";
                        if(flag == 1){
                            viewed = "<a href=\"javascript:bf_set_flag(\'"+column+"\',false,\'"+record_id+"\',\'"+flag_div_id+"\')\"><img src=\"media/com_breezingformsng/images/site/icons/publish_g.png\" border=\"0\"></a>";
                         }
            ...
            jQuery(document).ready(function () {
                ...
                var default_fields = {
                    ...
                    bfrecord_details: {
                        ...
                        display: function (detail_data) {
                            ...
                            var $img = jQuery("<img style=\"width: 16px !important; min-width: 16px !important; max-width: 16px !important; cursor: pointer;opacity: 0.5;\" onmouseover=\"this.style.opacity=\'1.0\'\" onmouseout=\"this.style.opacity=\'0.5\'\" src=\"' . Uri::root() . '/components/com_breezingformsng/libraries/jquery/jtable/themes/metro/list_metro.png' . '\" title=\"\" />");
                ...
                var default_object = {
                    title: "",
                    actions: {
                        listAction: "index.php?option=com_breezingformsng&act=recordmanagement&task=getListRecords&form_selection=0",
                        deleteAction: "index.php?option=com_breezingformsng&act=recordmanagement&task=action&action=delete"
                    },
                ...
                jQuery("#bfFormSelection").on("change",function(){
                    ...
                    default_object["actions"]["listAction"] = "index.php?option=com_breezingformsng&act=recordmanagement&task=getListRecords&form_selection="+form_selection;
                ...
                function bfupdatetable(){
                    ...
                    custom_object["actions"]["listAction"]  = "index.php?option=com_breezingformsng&act=recordmanagement&task=getListRecords&form_selection="+form_selection+searchterm+searchdatefrom+searchtimefrom+searchdateto+searchtimeto;
                    default_object["actions"]["listAction"] = "index.php?option=com_breezingformsng&act=recordmanagement&task=getListRecords&form_selection="+form_selection+searchterm+searchdatefrom+searchtimefrom+searchdateto+searchtimeto;
                                ...
                                custom_object["fields"][pfx+field_name] = {
                                    ...
                                    display: function(data){
                                        ...
                                        if(typeof data.record["bfrecord_custom_element_type_"+field_name] != "undefined" && data.record["bfrecord_custom_element_type_"+field_name] != "File Upload" && data.record["bfrecord_custom_element_type_"+field_name] !== null){
                                            ...
                                            var viewed = "<div id=\"bfFlag"+field_name+data.record["bfrecord_id"]+"\"><a href=\"javascript:bf_set_flag(\'"+field_name+"\',true,\'"+data.record["bfrecord_id"]+"\',\'bfFlag"+field_name+data.record["bfrecord_id"]+"\')\"><img src=\"media/com_breezingformsng/images/site/icons/publish_x.png\" border=\"0\"></a></div>";
                                            if(data.record[pfx+field_name] == 1){
                                                viewed = "<div id=\"bfFlag"+field_name+data.record["bfrecord_id"]+"\"><a href=\"javascript:bf_set_flag(\'"+field_name+"\',false,\'"+data.record["bfrecord_id"]+"\',\'bfFlag"+field_name+data.record["bfrecord_id"]+"\')\"><img src=\"media/com_breezingformsng/images/site/icons/publish_g.png\" border=\"0\"></a></div>";
                                            }
                                            return viewed;
                                        }else{
    ...
    function deleteRecord()
    {
        ...
        if ($isContentBuilder) {
            ...
            foreach ($cbRecords as $cbRecord) {
                ...
                $db->execute();
                $db->setQuery("Delete From #__contentbuilderng_records Where `type` = 'com_breezingformsng' And `reference_id` = " . $db->Quote($cbRecord['reference_id']) . " And record_id = " . $db->Quote(BFRequest::getInt('bfrecord_id')));
                $db->execute();
    ...
    function exportCsv()
    {
        ...
        $csvname = JPATH_SITE . '/components/com_breezingformsng/exports/' . ($form_name != '' ? $form_name . '-' : '') . 'ffexport-' . $date_stamp . '.csv';
        ...
        /*
          ...
          $path = JPATH_SITE.'/components/com_breezingformsng/exports/ffexport-csv-'.date('YmdHis').'.zip';
