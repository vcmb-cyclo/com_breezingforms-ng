    ...
    public static function showApplication($formId, $formName, $formTitle, $formDesc, $formEmailntf, $formEmailadr, $dataObjectString, $elementScripts, $themes, $themesbootstrap, $themesbootstrap3)
    {
        ...
        <script type="text/javascript">
            ...
            function BF_QuickModeApp() {
                ...
                this.dataObject = <?php echo str_replace("..\\/administrator\\/components\\/com_facileforms", "..\\/administrator\\/components\\/com_breezingformsng", $dataObjectString) ?>;

                <?php require_once(JPATH_SITE . '/administrator/components/com_breezingformsng/admin/quickmode-elements-js.php'); ?>
